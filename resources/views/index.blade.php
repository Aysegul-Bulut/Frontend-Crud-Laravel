...
<body>
    <nav class="navbar navbar-expand-lg bg-secondary">
        <div class="container-fluid">
            <a class="navbar-brand h1" style="color: white" href="{{ route('index') }}">Ürünler</a>
                ...
                <div class="col-md-12 mt-5">
                    <div class="card">
                        ...
                        <div class="card-footer">                           
                                <div class="row">
                                    <div class="col-sm">
                                        <a href="{{ route('edit', $product['id']) }}" class="btn btn-primary btn-sm">Düzenle</a>
                                    </div>
                                    <div class="col-sm">
                                    ...
                                    <div class="col-sm">
                                        <a href="{{ route('show', $product['id']) }}" class="btn btn-info btn-sm">Detay</a>
                                    </div>
                                </div>
                        </div>
                    </div>
